...
#define UNICAST_SWITCH_BUTTON DK_BTN2
#define UNICAST_SWITCH_BUTTON_MASK DK_BTN2_MSK
#define GROUP_SWITCH_BUTTON DK_BTN3
#define GROUP_SWITCH_BUTTON_MASK DK_BTN3_MSK
