...
#define CHIP_CONFIG_ADDRESS_RESOLVE_MIN_LOOKUP_DEFAULT_TIME_MS 100
#endif

#ifndef CHIP_CONFIG_ADDRESS_RESOLVE_MAX_LOOKUP_DEFAULT_TIME_MS
#define CHIP_CONFIG_ADDRESS_RESOLVE_MAX_LOOKUP_DEFAULT_TIME_MS                                                                     \
    (CHIP_DEVICE_CONFIG_SED_IDLE_INTERVAL + CHIP_DEVICE_CONFIG_SED_ACTIVE_INTERVAL)
#endif
