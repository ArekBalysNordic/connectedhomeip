...
class PartitionCreator:
    ...
    def generate_cbor(self):
        ...
        if self.__data_to_save:
            ...
            with open(self._output + ".cbor", "w+b") as cbor_output:
...
def main():
    ...
    parser.add_argument("-o", "--output", type=str, required=True,
                        help="Path to output file without any extension, where .hex, .cbor and .bin files will be stored. eg. setting output/output causes creation following files: output.hex, output.cbor and output.bin")
